...
[**size**](https://linux.die.net/man/1/size)
[**ldd**](https://linux.die.net/man/1/ldd)
[**nm**](https://linux.die.net/man/1/nm)
[**the most useful 10 nm commands**](https://www.thegeekstuff.com/2012/03/linux-nm-command/)
[**objdump**](https://linux.die.net/man/1/objdump)
[**readelf**](https://linux.die.net/man/1/readelf)
[**the Binary File Descriptor**](https://en.wikipedia.org/wiki/Binary_File_Descriptor_library)
[**chrpath**](https://linux.die.net/man/1/chrpath)
[**patchelf**](https://nixos.org/patchelf.html)
[**strip**](https://linux.die.net/man/1/strip)
